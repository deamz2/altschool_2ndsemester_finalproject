...
# INSTALLATION OF LAMP STACK && Installation of Ansible
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=dimeji/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=dimeji/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=awoyemi12/' /var/www/html/laravel/.env
